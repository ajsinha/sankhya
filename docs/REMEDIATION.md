...
closed the strict half on 2026-09-09, `M22b` and `M23` closed the rest on 2026-09-14 — the
subtree total through the set-valued walk, and the dimension table actually opened — and
`IMPLEMENTATION_PLAN.md` §13k sequences what is still absent.
...
exception thirty minutes in. The catalogue is **945 distinct defects**.
