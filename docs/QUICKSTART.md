...
python3 tools/mutation-audit.py  # 945 deliberate defects, applied one at a time
```
...
*"the tests pass, but do they test anything?"*: it applies 945 specific defects one at a time
