...
python3 tools/mutation-audit.py  # 371 deliberate defects, applied one at a time
...
applies 371 specific defects one at a time and requires the suite to fail on each. Twenty-nine
...
while — it is 371 sequential `cargo test` runs, and it edits your source files as it goes,
