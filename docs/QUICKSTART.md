...
python3 tools/mutation-audit.py  # 938 deliberate defects, applied one at a time
```
...
*"the tests pass, but do they test anything?"*: it applies 938 specific defects one at a time
