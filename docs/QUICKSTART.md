...
| `sankhya-schema` | Every type either round-trips exactly or is refused with a reason |
...
| Automatic table onboarding | **In progress** — the type mapping and decoder exist; the pipeline that joins them does not |
