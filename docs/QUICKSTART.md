...
python3 tools/mutation-audit.py  # 375 deliberate defects, applied one at a time
...
applies 375 specific defects one at a time and requires the suite to fail on each. Twenty-nine
...
while — it is 375 sequential `cargo test` runs, and it edits your source files as it goes,
