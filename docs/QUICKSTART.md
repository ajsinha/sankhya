...
python3 tools/mutation-audit.py  # 948 deliberate defects, applied one at a time
```
...
*"the tests pass, but do they test anything?"*: it applies 948 specific defects one at a time
