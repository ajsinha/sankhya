...
python3 tools/mutation-audit.py  # 359 deliberate defects, applied one at a time
...
applies 359 specific defects one at a time and requires the suite to fail on each. Twenty-nine
...
while — it is 359 sequential `cargo test` runs, and it edits your source files as it goes,
