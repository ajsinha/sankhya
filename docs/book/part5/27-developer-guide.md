...
python3 tools/mutation-audit.py              # 850 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 850 sequential cargo test runs
