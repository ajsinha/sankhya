...
python3 tools/mutation-audit.py              # 629 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 629 sequential cargo test runs
