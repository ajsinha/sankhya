...
python3 tools/mutation-audit.py              # 640 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 640 sequential cargo test runs
