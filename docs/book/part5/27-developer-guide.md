...
python3 tools/mutation-audit.py              # 729 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 729 sequential cargo test runs
