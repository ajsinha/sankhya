...
python3 tools/mutation-audit.py              # 769 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 769 sequential cargo test runs
