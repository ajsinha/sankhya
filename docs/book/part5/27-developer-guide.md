...
python3 tools/mutation-audit.py              # 832 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 832 sequential cargo test runs
