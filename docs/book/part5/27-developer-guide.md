...
python3 tools/mutation-audit.py              # 856 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 856 sequential cargo test runs
