...
python3 tools/mutation-audit.py              # 901 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 901 sequential cargo test runs
