...
python3 tools/mutation-audit.py              # 891 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 891 sequential cargo test runs
