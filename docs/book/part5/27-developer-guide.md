...
python3 tools/mutation-audit.py              # 657 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 657 sequential cargo test runs
