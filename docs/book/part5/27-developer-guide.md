...
python3 tools/mutation-audit.py              # 645 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 645 sequential cargo test runs
