...
python3 tools/mutation-audit.py              # 708 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 708 sequential cargo test runs
