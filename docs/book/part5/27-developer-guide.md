...
python3 tools/mutation-audit.py              # 625 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 625 sequential cargo test runs
