...
python3 tools/mutation-audit.py              # 809 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 809 sequential cargo test runs
