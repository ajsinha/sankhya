...
python3 tools/mutation-audit.py              # 898 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 898 sequential cargo test runs
