...
python3 tools/mutation-audit.py              # 711 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 711 sequential cargo test runs
