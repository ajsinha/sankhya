...
python3 tools/mutation-audit.py              # 724 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 724 sequential cargo test runs
