...
python3 tools/mutation-audit.py              # 658 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 658 sequential cargo test runs
