...
python3 tools/mutation-audit.py              # 741 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 741 sequential cargo test runs
