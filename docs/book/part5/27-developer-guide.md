...
python3 tools/mutation-audit.py              # 908 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 908 sequential cargo test runs
