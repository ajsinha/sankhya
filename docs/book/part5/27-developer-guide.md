...
python3 tools/mutation-audit.py              # 813 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 813 sequential cargo test runs
