...
python3 tools/mutation-audit.py              # 844 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 844 sequential cargo test runs
