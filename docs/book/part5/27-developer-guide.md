...
python3 tools/mutation-audit.py              # 826 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 826 sequential cargo test runs
