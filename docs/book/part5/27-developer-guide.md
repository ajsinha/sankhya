...
python3 tools/mutation-audit.py              # 626 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 626 sequential cargo test runs
