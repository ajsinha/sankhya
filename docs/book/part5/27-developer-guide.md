...
python3 tools/mutation-audit.py              # 863 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 863 sequential cargo test runs
