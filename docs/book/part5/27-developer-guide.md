...
python3 tools/mutation-audit.py              # 728 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 728 sequential cargo test runs
