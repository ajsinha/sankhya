...
python3 tools/mutation-audit.py              # 838 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 838 sequential cargo test runs
