...
python3 tools/mutation-audit.py              # 695 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 695 sequential cargo test runs
