...
python3 tools/mutation-audit.py              # 823 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 823 sequential cargo test runs
