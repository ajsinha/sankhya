...
python3 tools/mutation-audit.py              # 628 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 628 sequential cargo test runs
