...
python3 tools/mutation-audit.py              # 896 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 896 sequential cargo test runs
