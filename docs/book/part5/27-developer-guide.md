...
python3 tools/mutation-audit.py              # 804 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 804 sequential cargo test runs
