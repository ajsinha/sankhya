...
python3 tools/mutation-audit.py              # 904 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 904 sequential cargo test runs
