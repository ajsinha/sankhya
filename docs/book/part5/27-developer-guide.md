...
python3 tools/mutation-audit.py              # 818 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 818 sequential cargo test runs
