...
python3 tools/mutation-audit.py              # 878 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 878 sequential cargo test runs
