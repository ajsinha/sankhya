...
python3 tools/mutation-audit.py              # 631 deliberate defects, one at a time
...
```bash
python3 tools/mutation-audit.py            # the whole catalogue: 631 sequential cargo test runs
