...
cores and 335 GB; this is twelve cores and 62 GB. That makes the results conservative
...
| Q3 three-way join | 335 ms | 372 ms |
...
cargo test --workspace           # 1,568 tests, none of which needs a database
cargo xtask check-performance    # the NFR-PERF objectives, as a gate that can fail
python3 tools/mutation-audit.py  # 335 specific defects, applied one at a time
