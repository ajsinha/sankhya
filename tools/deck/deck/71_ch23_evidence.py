...
h = table(sl, [
    ...
    ["Tests", "does it do the thing?", "behaviour changes", "2,857 tests"],
    ["Gates", "does the repository still hold its own rules?", "a rule breaks anywhere, **including in a document**", "27"],
    ["Mutations", "would the tests notice if it stopped?", "a deliberate defect survives the suite", "928 deliberate defects"],
